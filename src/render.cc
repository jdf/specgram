...
const std::vector<Palette> kPalettes = {
    // matplotlib's magma, sampled at 16 even points from the canonical
    // 256-entry table: perceptually uniform lightness, black floor.
    {"magma",
     {0x00, 0x00, 0x04},
     {0x38, 0x38, 0x35},
     {0x89, 0x87, 0x81},
     {{0x00, 0x00, 0x04}, {0x0b, 0x09, 0x24}, {0x20, 0x11, 0x4b},
      {0x3b, 0x0f, 0x70}, {0x57, 0x15, 0x7e}, {0x72, 0x1f, 0x81},
      {0x8c, 0x29, 0x81}, {0xa8, 0x32, 0x7d}, {0xc4, 0x3c, 0x75},
      {0xde, 0x49, 0x68}, {0xf1, 0x60, 0x5d}, {0xfa, 0x7f, 0x5e},
      {0xfe, 0x9f, 0x6d}, {0xfe, 0xbf, 0x84}, {0xfd, 0xde, 0xa0},
      {0xfc, 0xfd, 0xbf}}},
    {"dark",
     {0x1a, 0x1a, 0x19},
     {0x38, 0x38, 0x35},
